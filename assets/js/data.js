...
const DEFAULT_DATA = {
  ...
  experience: [
    {
      period: "Dec 2022 – 2023 · Hsinchu, Taiwan",
      role: "Engineer — R&D",
      company: "Young Optics Inc., Taiwan",
      desc: "Worked in the Lens Development Department (R&D) responsible for setup and maintenance of automatic lens assembly machines. Utilized MTF (Modulation Transfer Function) machines to measure and analyse optical performance data. Developed engineering modifications based on test data to continuously improve lens product quality and reduce production downtime.",
      tags: ["Optical Engineering","MTF Analysis","Machine Setup","R&D","Process Optimization"]
    },
    {
      period: "Dec 2021 – Jun 2022 · Dhaka, Bangladesh",
      role: "CAD Trainer",
      company: "CADD & Engineering Solutions",
      desc: "Conducted professional training courses in AutoCAD 2D drawing and drafting, and SOLIDWORKS 3D design for engineering students and industry professionals.",
      tags: ["AutoCAD","SOLIDWORKS","Technical Training"]
    },
    {
      period: "Jan 2021 – Sep 2022 · Dhaka, Bangladesh",
      role: "Assistant Mechanical Engineer",
      company: "Integrated Design Consultants (Bangladesh)",
      desc: "Designed HVAC and fire protection systems for major national infrastructure projects. Prepared detailed design drawings, BOQ and cost estimations, attended coordination meetings, and conducted site supervision.",
      projects: [
        "Popular Medical College Hospital, Dhaka — Central A/C system (600 RT), cooling load calculation",
        ...
        "Sunnydale School Building, Bashundhara — Cooling load calculation & design drawing (1200 RT)",
    ...
    {
      period: "Dec 2020 – Jan 2021 · Nilphamari, Bangladesh",
      role: "Assistant Engineer — AutoCAD",
      company: "Mazen (BD) Industries Ltd.",
      desc: "Performed 2D drafting of industrial products from prototype samples and PDF references. Visited factory floors to understand production processes and translate complex designs into technical drawings.",
  ...
  education: [
    {
      period: "2023 – 2025",
      degree: "MSc Mechanical & Manufacturing Engineering",
    ...
    },
    {
      ...
      institution: "Bangladesh Army University of Science & Technology (BAUST), Saidpur",
      detail: "CGPA: 2.94 · 162 Credits. Thesis: 'Design and Simulation of a Low-Subsonic Wind Tunnel'. Academic Excellence Scholarship recipient. Executive member: ME Society, CAD Society, Mechatronics & Robotics Club."
    },
    {
      period: "Professional Development",
      degree: "Short Courses & Certifications",
      institution: "Cornell University (edX) · Involute Tech BD · TTTI",
  ...
  projects: [
    ...
    {
      type: "BSc Thesis · Aerodynamics",
      title: "Design & Simulation of a Low-Subsonic Wind Tunnel",
      desc: "Designed an open-circuit low-subsonic wind tunnel from first principles. Covered contraction ratio design, diffuser geometry, honeycomb/screen specifications, and CFD validation of internal flow uniformity and turbulence intensity at the test section.",
      outcome: "Target flow uniformity achieved in test section; validated via CFD simulation",
  ...
  skillGroups: [
    {
      ...
      skills: [
        { name:"ANSYS Fluent", pct:90 },
        { name:"ANSYS Workbench", pct:85 },
        { name:"OpenFOAM", pct:50 },
        { name:"VOF Multiphase Modelling", pct:null },
        { name:"FEA Analysis", pct:null }
      ]
    },
    {
      title: "CAD & Design",
      skills: [
        { name:"SOLIDWORKS", pct:90 },
        { name:"AutoCAD", pct:92 },
        { name:"FreeCAD", pct:60 },
        { name:"3D Modelling & Drafting", pct:null },
        { name:"HVAC System Design", pct:null }
      ]
    },
    {
      title: "Manufacturing & Process",
      skills: [
        { name:"Lean Manufacturing", pct:null },
    ...
    },
    {
      ...
      skills: [
        { name:"Fluid Mechanics & CFD", pct:null },
    ...
    },
    {
      ...
      skills: [
        { name:"Microsoft Office (Advanced)", pct:95 },
        { name:"Windows & Linux (Ubuntu)", pct:null },
        { name:"Python (Beginner)", pct:30 },
        { name:"UDF — ANSYS Fluent", pct:null }
      ]
    },
    {
      title: "Professional Skills",
      skills: [
        { name:"Technical Report Writing", pct:null },
  ...
  honours: [
    { icon:"★", text:"<strong>Academic Excellence Scholarship</strong> — Bangladesh Army University of Science and Technology (BAUST), BSc Mechanical Engineering" },
